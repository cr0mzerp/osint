...
# Set OSINT_LOG_ROOT to the Terabox storage path (after mount)
export OSINT_LOG_ROOT="/mnt/alist/terabox_data"
...
# Rclone mount (background) - mount WebDAV root
rclone mount alist-webdav:/ /mnt/alist \
    --vfs-cache-mode full \
...
sleep 2
if mountpoint -q /mnt/alist; then
    echo "Mount başarılı: /mnt/alist"
    ls -la /mnt/alist | head -20
else
